...
/**
 * Mission Control -- the deep-work view for running full multi-agent
 * missions (research -> product -> engineering -> preview). Moved from `/`
 * to `/missions`: the default landing view is now the Executive Dashboard,
 * since JARVIS's primary job is operating the founder's businesses, and
 * missions are one tool inside that.
 */
